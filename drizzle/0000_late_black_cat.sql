...
CREATE TYPE "public"."user_role" AS ENUM('ADMIN', 'CUSTOMER', 'B2B_FOUNDER', 'B2B_SALESPERSON', 'B2B_CREATOR', 'B2B_MARKETER', 'ENTREPRENEUR', 'PROFESSIONAL', 'JOB_SEEKER', 'STUDENT', 'OTHER');--> statement-breakpoint
